...
})({"dCyvf":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4e9a5710dcb881e5";
...
},{}],"bBAaA":[function(require,module,exports) {
...
var _signerConnection = require("@walletconnect/signer-connection");
class WalletConnectProvider {
    constructor(opts){
        this.events = new (0, _eventemitter3Default.default)();
        this.rpc = {
            infuraId: opts === null || opts === void 0 ? void 0 : opts.infuraId,
            custom: opts === null || opts === void 0 ? void 0 : opts.rpc
        };
        this.signer = new (0, _jsonrpcProvider.JsonRpcProvider)(new (0, _signerConnection.SignerConnection)(opts));
    ...
    async request(args) {
        ...
        if ((0, _utils.signingMethods).includes(args.method)) return this.signer.request(args);
        if (typeof this.http === "undefined") throw new Error(`Cannot request JSON-RPC method (${args.method}) without provided rpc url`);
    ...
    async connect() {
        if (!this.signer.connection.connected) await this.signer.connect();
    }
    async disconnect() {
        if (this.signer.connection.connected) await this.signer.disconnect();
    }
    on(event, listener) {
    ...
    setHttpProvider(chainId) {
        const rpcUrl = (0, _utils.getRpcUrl)(chainId, this.rpc);
        if (typeof rpcUrl === "undefined") return undefined;
        const http = new (0, _jsonrpcProvider.JsonRpcProvider)(new (0, _jsonrpcHttpConnection.HttpConnection)(rpcUrl));
        return http;
    }
}
exports.default = WalletConnectProvider;

},{"eventemitter3":"3fnfh","@walletconnect/jsonrpc-provider":"6zGTK","@walletconnect/jsonrpc-http-connection":"dtBb9","@walletconnect/utils":"lXjaj","@walletconnect/signer-connection":"6KFu5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3fnfh":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dtBb9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"cD1pC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lXjaj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/window-getters":"7XcJM"}],"7XcJM":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{"bn.js":"VopIn","@walletconnect/encoding":"2NXLj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"VopIn":[function(require,module,exports) {
...
},{"buffer":"jhUEF"}],"2NXLj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"is-typedarray":"aCwce","typedarray-to-buffer":"2lRgC","buffer":"fCgem","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aCwce":[function(require,module,exports) {
...
},{"buffer":"fCgem","is-typedarray":"aCwce"}],"fCgem":[function(require,module,exports) {
/*!
...
},{}],"fSzyo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/encoding":"2NXLj","@walletconnect/jsonrpc-utils":"izCJ8","./constants":"66pHN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1lESp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"query-string":"11cDl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"11cDl":[function(require,module,exports) {
"use strict";
...
},{"strict-uri-encode":"72Fvn","decode-uri-component":"1clyr","split-on-first":"70WYe"}],"72Fvn":[function(require,module,exports) {
"use strict";
...
},{}],"6KFu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SignerConnection", ()=>SignerConnection);
var _eventemitter3 = require("eventemitter3");
var _eventemitter3Default = parcelHelpers.interopDefault(_eventemitter3);
...
var _jsonrpcTypes = require("@walletconnect/jsonrpc-types");
var _jsonrpcUtils = require("@walletconnect/jsonrpc-utils");
class SignerConnection extends (0, _jsonrpcTypes.IJsonRpcConnection) {
    constructor(opts){
        super();
        this.events = new (0, _eventemitter3Default.default)();
        this.accounts = [];
    ...
    async close() {
        ...
        if (this.wc.connected) this.wc.killSession();
        this.onClose();
    }
    async send(payload) {
        this.wc = this.register(this.opts);
        if (!this.connected) await this.open();
        this.sendPayload(payload).then((res)=>this.events.emit("payload", res)).catch((e)=>this.events.emit("payload", (0, _jsonrpcUtils.formatJsonRpcError)(payload.id, e.message)));
    }
    register(opts) {
        ...
        const connectorOpts = {
            bridge: this.bridge,
            qrcodeModal: this.qrcode ? (0, _qrcodeModalDefault.default) : undefined,
            qrcodeModalOptions: this.qrcodeModalOptions,
            storageId: opts === null || opts === void 0 ? void 0 : opts.storageId,
            signingMethods: opts === null || opts === void 0 ? void 0 : opts.signingMethods,
            clientMeta: opts === null || opts === void 0 ? void 0 : opts.clientMeta
        };
        this.wc = typeof (opts === null || opts === void 0 ? void 0 : opts.connector) !== "undefined" ? opts.connector : new (0, _clientDefault.default)(connectorOpts);
        if (typeof this.wc === "undefined") throw new Error("Failed to register WalletConnect connector");
        if (this.wc.accounts.length) this.accounts = this.wc.accounts;
        if (this.wc.chainId) this.chainId = this.wc.chainId;
    ...
    onError(payload, message = "Failed or Rejected Request", code = -32000, data) {
        ...
        if (typeof data !== "undefined") errorPayload.error.data = data;
    ...
    sanitizeResponse(response) {
        return typeof response.error !== "undefined" && typeof response.error.code === "undefined" ? (0, _jsonrpcUtils.formatJsonRpcError)(response.id, response.error.message, response.error.data) : response;
    }
}
exports.default = SignerConnection;

},{"eventemitter3":"3fnfh","@walletconnect/client":"a2dbO","@walletconnect/qrcode-modal":"hLnYZ","@walletconnect/jsonrpc-types":"TA1tb","@walletconnect/jsonrpc-utils":"izCJ8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2dbO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@walletconnect/utils":"lXjaj","@walletconnect/socket-transport":"89RYI","./errors":"lKq8L","./events":"bAwEf","./storage":"gBNRz","./url":"h55Bs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"89RYI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("@walletconnect/utils");
...
},{"@walletconnect/utils":"lXjaj","./network":"kD3Pe","ws":"4OuWD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kD3Pe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../lib/browser":"3M53l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hLnYZ":[function(require,module,exports) {
var process = require("process");
...
},{"process":"d5jf4","@walletconnect/browser-utils":"1ExPT","qrcode":"lB7MY","copy-to-clipboard":"fLPFI","preact/compat":"6kbdV"}],"lB7MY":[function(require,module,exports) {
...
},{"../utils/buffer":"ctzhM","./utils":"iXLHI","./error-correction-level":"kbPwo","./bit-buffer":"kiPfj","./bit-matrix":"fTjkX","./alignment-pattern":"1o9KB","./finder-pattern":"dc6Ma","./mask-pattern":"fyimH","./error-correction-code":"5yWYH","./reed-solomon-encoder":"47Qq0","./version":"a8ag2","./format-info":"iThdR","./mode":"f1e9A","./segments":"4tKki","isarray":"6BgcY"}],"ctzhM":[function(require,module,exports) {
/**
...
},{"isarray":"6BgcY"}],"6BgcY":[function(require,module,exports) {
...
},{"./utils":"iXLHI","./error-correction-code":"5yWYH","./error-correction-level":"kbPwo","./mode":"f1e9A","./version-check":"enfTX","isarray":"6BgcY"}],"f1e9A":[function(require,module,exports) {
var VersionCheck = require("./version-check");
...
},{}],"6kbdV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact/hooks":"4w0EP","preact":"8MrVw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4w0EP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _preact.options).__r = function(n) {
    ...
    if (u) {
        ...
        if (r) try {
            ...
            (0, _preact.options).__e(t1, u.__v);
        }
    }
};

},{"preact":"8MrVw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8MrVw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dCyvf"], null, "parcelRequire3745")

//# sourceMappingURL=esm.dcb881e5.js.map
